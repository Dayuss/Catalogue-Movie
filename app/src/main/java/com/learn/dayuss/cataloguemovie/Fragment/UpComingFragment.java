...
public class UpComingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_up_coming, container, false);
        recyclerView = rootView.findViewById(R.id.rv_movieuc);
    ...
    public void loadMovieData(){
        ...
        call = apiService.getUpcoming(BuildConfig.API_KEY);
